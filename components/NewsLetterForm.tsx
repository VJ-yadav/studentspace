...
function NewsLetterForm() {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        if (!active) {
            ...
            setActive(true);
            //to gsap animation -- Animation for the paper plane
            to(button, {
            ...
            //to gsap animation - animation for the trails.

            to(button, { keyframes: getTrailsKeyframes(button) });

        }

        // Post REQUEST to the mailing Service
        ...
        <div className="flex flex-col space-y-8 md:w-[400px]">
            <form className="newsletter-form mt-10 animate-fade-in-3" onSubmit={handleSubmit}>
                <div className="group flex items-center gap-x-4 py-1 pl-4, pr-1 rounded-[9px]
                 bg-[#090d11] hover:bg-[#15141B] shadow-outline-gray hover:shadow-transparent focus-within:bg-[#15141B]
